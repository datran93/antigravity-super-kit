...
model: inherit
skills: clean-code, database-design, database-architect, database-optimizer, database-migration, postgresql, supabase-postgres-best-practices, vector-database-engineer
---
