...
model: inherit
skills:
  clean-code, react-best-practices, web-design-guidelines, tailwind-patterns,
  frontend-design, lint-and-validate, frontend-developer, core-components,
  design-orchestration, i18n-localization, seo-fundamentals, geo-fundamentals
---
...
> **Note:** This agent loads relevant skills (clean-code, react-best-practices,
