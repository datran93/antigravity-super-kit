...
model: inherit
skills: clean-code, deployment-procedures, server-management, powershell-windows, bash-linux, docker-expert, kubernetes-architect, git-advanced-workflows, linux-shell-scripting
---
