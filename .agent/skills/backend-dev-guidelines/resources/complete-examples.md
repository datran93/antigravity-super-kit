...
export class UserController extends BaseController {
  ...
  async getUser(req: Request, res: Response): Promise<void> {
    try {
      ...
      const user = await this.withTransaction("user.get", "db.query", () => this.userService.findById(req.params.id));
  ...
  async createUser(req: Request, res: Response): Promise<void> {
    try {
      ...
      // Track performance
      const user = await this.withTransaction("user.create", "db.mutation", () => this.userService.create(validated));
