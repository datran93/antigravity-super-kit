...
Use `{{"Your prompt here"}}` to ask the AI Interpreter to extract or summarize info. _Requires Interpreter to be
enabled._
...
Extract content using CSS selectors. Syntax: `{{selector:css-selector}}` or `{{selector:css-selector?attribute}}`
...
Extract data from meta tags. Syntax: `{{meta:name}}` or `{{meta:property}}`
...
Extract structured data. Syntax: `{{schema:Property}}` or `{{schema:@Type:Property}}`
