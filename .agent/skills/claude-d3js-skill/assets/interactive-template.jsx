...
function InteractiveChart({ data }) {
  ...
  return (
    <div className="relative">
      <svg ref={svgRef} width="800" height="500" style={{ border: "1px solid #ddd", cursor: "grab" }} />
      <div
        ref={tooltipRef}
        style={{
          position: "absolute",
...
export default function App() {
  ...
  return (
    <div className="p-8">
      ...
      <p className="text-gray-600 mb-4">Hover over points for details. Click to select. Scroll to zoom. Drag to pan.</p>
