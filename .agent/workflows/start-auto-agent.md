...
Use this when you want Agents to forget all previous history (clear DB) and start a brand-new project in the current Workspace. 

**Usage**: `/start-auto-agent [-e|--engine <kilocode|opencode|gemini|copilot>] "<Initial Request>"`
