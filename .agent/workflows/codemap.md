...
This workflow guides you to create a visual representation of the project's architecture, data flows, and module relationships. It helps on-board new developers (and refresh yourself) on how the system is structured.

## 🚀 Execution Phase

### Phase 1: Structural Discovery 🔍
- Use `@mcp:ast-explorer` to map the high-level project structure.
