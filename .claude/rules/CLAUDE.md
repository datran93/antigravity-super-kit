...
> **Goal**: Avoid loading the entire `ANCHORS.md` file on every session. Only load the domain-specific constraints
> that are relevant to the current task to save input tokens and improve LLM focus.
