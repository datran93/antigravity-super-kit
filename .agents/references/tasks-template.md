...
> This is the canonical template for `features/{slug}/tasks.md`. The Planner MUST follow this structure. This file is
> the **human-readable** task list. MCP `initialize_task_plan` remains the **agent-state** source of truth.
...
> **Goal**: _story goal statement_ **Independent Test**: _how to verify this story works end-to-end_ **MVP Scope**: Yes
...
> **Goal**: _story goal statement_ **Independent Test**: _how to verify this story works end-to-end_
