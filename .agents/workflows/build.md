...
Inject gotchas via `annotate_file`, then deliver:
...
**Files Created**: list
**Files Modified**: list
**Pattern Followed**: which existing pattern
**Verified**: test results
**Recommended Next**: /reviewer-audit
```

> 🛑 **STOP HERE.** The USER decides: proceed to `/reviewer-audit`, commit directly, or continue.
