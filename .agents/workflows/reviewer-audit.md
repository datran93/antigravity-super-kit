...
6. **Auto-Linked Integrity**: Review the Auto-Linked tags (`@task-[ID]`, `@ki/[Name]`, `@anchor/[Key]`) used in the
   specification and Coder notes. Pay attention to any validation warnings or errors generated by the
